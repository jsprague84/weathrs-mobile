/**
 * SchedulerModal - Full scheduler UI wrapped in a modal
 *
 * Extracted from app/scheduler.tsx for use in Settings.
 * Contains all scheduler functionality: status, jobs CRUD, manual triggers.
 */
...
function JobFormModal({
  ...
  return (
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet">
      <View style={[styles.formModalContainer, { backgroundColor: colors.background, paddingTop: insets.top }]}>
        <View style={[styles.formModalHeader, { borderBottomColor: colors.border }]}>
          <Pressable onPress={onClose} hitSlop={8}>
            <Text style={[styles.formModalCancel, { color: colors.primary }]}>Cancel</Text>
          </Pressable>
          ...
          <Pressable onPress={handleSubmit} disabled={isSubmitting} hitSlop={8}>
            <Text style={[styles.formModalSave, { color: isSubmitting ? colors.textMuted : colors.primary }]}>
              {isSubmitting ? 'Saving...' : 'Save'}
            </Text>
          </Pressable>
        </View>

        <ScrollView style={styles.formModalContent} contentContainerStyle={styles.formModalScrollContent}>
          {/* Basic Info */}
    ...
    >
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.header, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
          <Text style={[styles.title, { color: colors.text }]}>Scheduled Forecasts</Text>
        ...
        {statusQuery.isLoading ? (
          <Loading message="Loading scheduler status..." />
        ) : (
          <ScrollView
